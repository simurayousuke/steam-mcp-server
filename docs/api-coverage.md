...
- Publisher-only user ticket authentication, app beta/build/depot/server metadata, partner app lists, banned-player records, Workshop finalized contributors, ownership, price, user group list, and deleted-SteamID read endpoints when `STEAM_PUBLISHER_KEY` is configured
