...
| `IPublishedFileService` | `steam_query_workshop_files`. | `Delete` and other published-file mutation methods. | https://partner.steamgames.com/doc/webapi/IPublishedFileService |
...
| `ISteamApps` | `steam_get_servers_at_address`, `steam_check_app_up_to_date`, and publisher app beta/build/depot/server metadata tools. | `SetAppBuildLive` and other publishing-state changes. | https://partner.steamgames.com/doc/webapi/ISteamApps |
